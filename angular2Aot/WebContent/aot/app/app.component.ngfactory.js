...
var View_AppComponent0 = (function (_super) {
    ...
    View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_1 = this.renderer.createText(this._el_0, 'App Component', null);
        ...
        this._vc_3 = new import9.ViewContainer(3, null, this, this._el_3);
        this._RouterOutlet_3_5 = new import10.Wrapper_RouterOutlet(this.parentView.injectorGet(import11.RouterOutletMap, this.parentIndex), this._vc_3.vcRef, this.parentView.injectorGet(import12.ComponentFactoryResolver, this.parentIndex), null);
