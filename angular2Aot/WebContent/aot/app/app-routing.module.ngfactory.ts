...
import * as import9 from './temp1/temp1.component.ngfactory';
import * as import10 from '@angular/common/src/location/platform_location';
...
import * as import13 from '../../app/temp1/temp1.component';
import * as import14 from '@angular/core/src/application_ref';
import * as import15 from '@angular/router/src/url_handling_strategy';
import * as import16 from '@angular/router/src/route_reuse_strategy';
import * as import17 from '@angular/router/src/router';
import * as import18 from '@angular/core/src/linker/ng_module_factory_loader';
...
class AppRoutingModuleInjector extends import0.NgModuleInjector<import1.AppRoutingModule> {
  ...
  constructor(parent:import8.Injector) {
    super(parent,[import9.Temp1ComponentNgFactory],([] as any[]));
  }
  ...
  get _LocationStrategy_4():any {
    if ((this.__LocationStrategy_4 == null)) { (this.__LocationStrategy_4 = import2.provideLocationStrategy(this.parent.get(import10.PlatformLocation),this.parent.get(import11.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_3)); }
  ...
  get _NgModuleFactoryLoader_8():import6.SystemJsNgModuleLoader {
    if ((this.__NgModuleFactoryLoader_8 == null)) { (this.__NgModuleFactoryLoader_8 = new import6.SystemJsNgModuleLoader(this.parent.get(import12.Compiler),this.parent.get(import6.SystemJsNgModuleLoaderConfig,(null as any)))); }
  ...
  get _ROUTES_9():any[] {
      if ((this.__ROUTES_9 == null)) { (this.__ROUTES_9 = [[
        {
          path: 'angular2Aot',
          component: import13.Temp1Component,
          pathMatch: 'full'
        }
        ,
        {
  ...
  get _Router_10():any {
    if ((this.__Router_10 == null)) { (this.__Router_10 = import2.setupRouter(this.parent.get(import14.ApplicationRef),this._UrlSerializer_6,this._RouterOutletMap_7,this._Location_5,this,this._NgModuleFactoryLoader_8,this.parent.get(import12.Compiler),this._ROUTES_9,this._ROUTER_CONFIGURATION_3,this.parent.get(import15.UrlHandlingStrategy,(null as any)),this.parent.get(import16.RouteReuseStrategy,(null as any)))); }
  ...
  createInternal():import1.AppRoutingModule {
    this._ROUTER_FORROOT_GUARD_0 = import2.provideForRootGuard(this.parent.get(import17.Router,(null as any)));
    ...
    this._RouterPreloader_14 = new import7.RouterPreloader(this._Router_10,this._NgModuleFactoryLoader_8,this.parent.get(import12.Compiler),this,this._PreloadingStrategy_13);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import11.LocationStrategy)) { return this._LocationStrategy_4; }
    ...
    if ((token === import18.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_8; }
    if ((token === import19.ROUTES)) { return this._ROUTES_9; }
    if ((token === import17.Router)) { return this._Router_10; }
    if ((token === import20.ActivatedRoute)) { return this._ActivatedRoute_11; }
    ...
    if ((token === import14.NgProbeToken)) { return this._NgProbeToken_16; }
    if ((token === import2.RouterInitializer)) { return this._RouterInitializer_17; }
    if ((token === import21.APP_INITIALIZER)) { return this._APP_INITIALIZER_18; }
    if ((token === import2.ROUTER_INITIALIZER)) { return this._ROUTER_INITIALIZER_19; }
    if ((token === import22.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_20; }
