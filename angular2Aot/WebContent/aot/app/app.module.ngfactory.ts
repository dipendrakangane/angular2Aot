...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  createInternal():import1.AppModule {
    ...
    this._ROUTER_FORROOT_GUARD_6 = import8.provideForRootGuard(this.parent.get(import47.Router,(null as any)));
    ...
    this._ApplicationRef__17 = new import13.ApplicationRef_(this.parent.get(import40.NgZone),this.parent.get(import48.Console),this,this._ErrorHandler_12,this,this._ApplicationInitStatus_15,this.parent.get(import12.TestabilityRegistry,(null as any)),this._Testability_16);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import49.ErrorHandler)) { return this._ErrorHandler_12; }
    ...
    if ((token === import50.DOCUMENT)) { return this._DOCUMENT_21; }
    ...
    if ((token === import51.AnimationDriver)) { return this._AnimationDriver_26; }
    ...
    if ((token === import52.RootRenderer)) { return this._RootRenderer_29; }
    if ((token === import19.DomSanitizer)) { return this._DomSanitizer_30; }
    if ((token === import53.Sanitizer)) { return this._Sanitizer_31; }
    if ((token === import20.AnimationQueue)) { return this._AnimationQueue_32; }
    if ((token === import21.ViewUtils)) { return this._ViewUtils_33; }
    if ((token === import54.IterableDiffers)) { return this._IterableDiffers_34; }
    if ((token === import55.KeyValueDiffers)) { return this._KeyValueDiffers_35; }
    ...
    if ((token === import56.XSRFStrategy)) { return this._XSRFStrategy_41; }
    ...
    if ((token === import58.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_50; }
    if ((token === import59.ROUTES)) { return this._ROUTES_51; }
    if ((token === import47.Router)) { return this._Router_52; }
    if ((token === import60.ActivatedRoute)) { return this._ActivatedRoute_53; }
